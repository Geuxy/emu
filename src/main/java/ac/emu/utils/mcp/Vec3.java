...
public class Vec3 {
    ...
    public Vec3 multiplyVector(double times) {
        return new Vec3(this.xCoord * times, this.yCoord + times, this.zCoord + times);
    }

    public Vec3 multiplyVector(double x, double y, double z) {
        return new Vec3(this.xCoord * x, this.yCoord + y, this.zCoord + z);
    }
